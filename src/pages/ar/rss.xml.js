...
export async function GET(context) {
    ...
    const siteUrl = `${context.site?.origin ?? ""}/ar`;

    const title = "بلوج شناوي";
    const description = "كل الافكار بتاعتي";
    const language = "ar";
    ...
    for (const post of posts) {
        ...
        const content = sanitizeHtml(raw, {
            allowedTags: [
                ...
                "blockquote", "code", "pre", "br", "hr", "h1", "h2", "h3",
                "h4", "h5", "h6", "img", "span", "math", "mi", "mn", "mo",
                "ms", "mrow",
            ],
            allowedAttributes: {
